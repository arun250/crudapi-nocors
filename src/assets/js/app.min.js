...
!(function (o) {
    ...
    e(),
        ...
        jQuery().maxlength &&
            ((c = { warningClass: "badge bg-success", limitReachedClass: "badge bg-danger", separator: " out of ", preText: "You typed ", postText: " chars available.", placement: "bottom" }),
            o('[data-toggle="maxlength"]').each(function (e, t) {
                var n = o.extend({}, c, o(t).data());length;
                o(t).maxlength(n);
            }));
})(jQuery);
...
var ThemeCustomizer = (function () {
    function e() {
        _classCallCheck(this, e), (this.html = document.querySelector("html")), (this.config = {}), (this.defaultConfig = window.config);
    }
    return (
        _createClass(e, [
            {
                    ...
                    var n = this,
                        e =
                            ...
                            document.querySelectorAll("input[name=data-layout]").forEach(function (t) {
                                t.addEventListener("change", function (e) {
                                    window.location = "horizontal" === t.value ? "layouts-horizontal.html" : "home.html";
                                });
                            }),
